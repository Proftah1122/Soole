...
export const FareBreakdown: React.FC<FareBreakdownProps> = ({ fare }) => {
  const total = fare.baseFare + fare.serviceCharge + fare.longDistanceFee;
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between">
          <span className="text-gray-400">Long Distance Fee</span>
          <span className="text-white">{formatCurrency(fare.longDistanceFee)}</span>
        </div>
